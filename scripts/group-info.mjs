...
function usage() {
  console.log("Usage: group-info.mjs update --group <id|name> [--dry-run|--write|--apply] [--skip-if-recent] | update-all [--dry-run|--write|--apply] [--skip-if-recent] | top --group <id|name> --dry-run|--apply | top-all [--dry-run|--apply] | list [--format json|md|table] | self-test");
}
